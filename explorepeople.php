  ...
  $dbp = mysqli_connect("localhost", "root","", "ask");
    ...
    <div class='row text-center' >
        ...
        <!--/Fourth column-->";
	     	   ...
	     	   echo "<button type='button'  class='btn btn-success btn-sm'  style='background-color:white; opacity:1; cursor:pointer;  margin-left:330px; height:30px;  ' data-toggle='modal' data-target='#imodal' ><font color='black' size='2' ><b>FOLLOW </b></font></button>";
