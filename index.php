...
$sml = "SELECT * FROM upvotes WHERE answerid='".$row['id']."'  AND upvoteuser='$username' ORDER BY  upvotes.id DESC ";
...
while($rowl = $resultl->fetch_assoc()) {
     	   ...
     	   echo "<button type='submit'  id='submitForm'  onclick='show();' name='submit' data-send='false' style='background-color:white; cursor:pointer; opacity:1;   margin-left:10px;' ><td style='text-align:center; width: 100%;'><i  class='fa fa-thumbs-up' aria-hidden='true' style='font-size: 1.5em; opacity:1;  color:#3CB371	;'></i></td> </button>";
...
{
	     	   echo "<button type='submit'  id='submitForm'  onclick='show();' name='submit' data-send='false' style='background-color:white; cursor:pointer; opacity:1;  margin-left:10px;' ><td style='text-align:center; width: 100%;'><i class='fa fa-thumbs-o-up' aria-hidden='true' style='font-size: 1.5em; opacity:1; color:green;  '></i></td> </button>";
...
$sml = "SELECT * FROM comments WHERE postid='".$row['id']."' AND type='answers' AND commentuser='$username' ORDER BY  comments.id DESC ";
